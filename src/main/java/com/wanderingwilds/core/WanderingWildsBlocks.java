...
import com.wanderingwilds.core.blocks.CactusFlower;
...
public class WanderingWildsBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(WanderingWilds.MOD_ID, name), block);
    }


    private static Item registerBlockItem(String name, Block block) {

        return Registry.register(Registries.ITEM, new Identifier(WanderingWilds.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));


    }

    public static void registerWanderingWildsBlocks() {
    }
}
